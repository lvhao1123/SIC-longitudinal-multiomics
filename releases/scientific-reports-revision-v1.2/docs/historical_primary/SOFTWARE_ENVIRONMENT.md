...
The Windows analysis environment used R 4.4.2. Dependency versions and transitive sources are recorded in `renv.lock`; Bioconductor packages resolve against Bioconductor 3.20.
