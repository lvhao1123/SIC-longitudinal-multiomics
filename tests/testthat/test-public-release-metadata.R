...
testthat::test_that("citation metadata uses the final identity without claiming an unreleased version", {
...
testthat::test_that("README distinguishes public code from controlled data", {
  ...
  testthat::expect_match(readme, "The intended submission release tag is", fixed = TRUE)
  testthat::expect_match(readme, "does not claim that the release already exists", fixed = TRUE)
